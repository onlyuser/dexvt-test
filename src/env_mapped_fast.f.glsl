...
void main(void) {
    vec4 reflected_color = textureCube(env_map_texture, fragment_reflected_flipped_cubemap_texcoord);
    vec4 refracted_color = textureCube(env_map_texture, fragment_refracted_flipped_cubemap_texcoord);
